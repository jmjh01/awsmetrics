...
$dataPoints = array( 
  array("label"=>"Prison", "y"=>$ptype),
  array("label"=>"Media", "y"=>$mtype),
  array("label"=>"Customer Care", "y"=>$cctype),
  array("label"=>"Others", "y"=>$otype),
  array("label"=>"Short_Files", "y"=>$sftype),
  array("label"=>"Unclassified", "y"=>$uctype)
)
